...
def eval_cuhk03(distmat, q_pids, g_pids, max_rank):
...
def evaluate_py(distmat, q_pids, g_pids, max_rank, use_metric_cuhk03):
    if use_metric_cuhk03:
        return eval_cuhk03(distmat, q_pids, g_pids, max_rank)
    else:
        return eval_market1501(distmat, q_pids, g_pids, max_rank)


def evaluate(distmat, q_pids, g_pids, max_rank=50, use_metric_cuhk03=False, use_cython=True):
    if use_cython and IS_CYTHON_AVAI:
        return evaluate_cy(distmat, q_pids, g_pids, max_rank, use_metric_cuhk03)
    else:
        return evaluate_py(distmat, q_pids, g_pids, max_rank, use_metric_cuhk03)